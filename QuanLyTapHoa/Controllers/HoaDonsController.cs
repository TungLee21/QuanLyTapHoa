...
namespace QuanLyTapHoa.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaTaiKhoan,Username,TongSoLuong,TongTien,TongTienThue")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaTaiKhoan,Username,TongSoLuong,TongTien,TongTienThue")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
