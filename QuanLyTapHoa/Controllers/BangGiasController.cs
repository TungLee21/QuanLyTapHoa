...
namespace QuanLyTapHoa.Controllers
{
    public class BangGiasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaBangGia,TenBangGia,NgayApDung")] BangGia bangGia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaBangGia,TenBangGia,NgayApDung")] BangGia bangGia)
        {
            if (ModelState.IsValid)
            {
