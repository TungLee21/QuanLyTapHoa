...
namespace QuanLyTapHoa.Controllers
{
    public class ChiTietHoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaHH,SoLuong,GiaBan,GiaGiam,MucThue,TienKhachDua,TienThoi")] ChiTietHoaDon chiTietHoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaHH,SoLuong,GiaBan,GiaGiam,MucThue,TienKhachDua,TienThoi")] ChiTietHoaDon chiTietHoaDon)
        {
            if (ModelState.IsValid)
            {
